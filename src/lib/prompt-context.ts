...
export function buildAnnotPrompt(input: AnnotPromptInput, screenshotInstruction: string): string {
  ...
  const contextLines = [
    ...
    '- Explain the way a warm, patient Indian teacher would to a student back home — friendly tone, everyday Indian idioms and turns of phrase, and analogies drawn from familiar Indian life (cricket, chai, trains, market haggling, festivals, joint families, exams, etc.) wherever they genuinely help the idea land.',
    ...
    '- Natural Hinglish touches (a familiar Hindi word or phrase mixed into the English sentence, the way Indian teachers actually talk) are welcome where they add clarity or warmth — but keep technical terms, code, and formulas precise and in English so nothing is lost in translation.',
